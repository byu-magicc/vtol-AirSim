...
#ifndef msr_airlib_TiltrotorSimpleBoard_hpp
#define msr_airlib_TiltrotorSimpleBoard_hpp
...
class TiltrotorSimpleBoard : public tiltrotor_simple::IBoard {
public:
    TiltrotorSimpleBoard(const tiltrotor_simple::Params* params)
        : params_(params)
    {
    }
...
private:
    ...
    const tiltrotor_simple::Params* params_;
