...
#include "vehicles/tiltrotor/firmwares/simple_flight/SimpleFlightApi.hpp"
...
class SimpleFlightQuadXParams : public TiltrotorParams {
public:
    ...
    {
        return std::unique_ptr<TiltrotorApiBase>(new SimpleFlightApi(this, vehicle_setting_));
    }
