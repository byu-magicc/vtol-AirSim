...
#include "vehicles/tiltrotor/firmwares/mavlink/ArduCopterSoloApi.hpp"

namespace msr { namespace airlib {


		class ArduCopterSoloParams : public TiltrotorParams {
		...
		public:
			...
			{
				unique_ptr<TiltrotorApiBase> api(new ArduCopterSoloApi());
