...
class ArduCopterApi : public TiltrotorApiBase {

public:
    ArduCopterApi(const TiltrotorParams* vehicle_params, const AirSimSettings::MavLinkConnectionInfo& connection_info)
...
public: //TODO:TiltrotorApiBase implementation
