...
#include "vehicles/tiltrotor/firmwares/arducopter/ArduCopterApi.hpp"
...
class ArduCopterParams : public TiltrotorParams {
public:
    ...
    {
        return std::unique_ptr<TiltrotorApiBase>(new ArduCopterApi(this, connection_info_));
    }
...
protected:
    virtual void setupParams() override
    {
        ...
        // Use connection_info_.model for the model name, see Px4TiltrotorParams for example
