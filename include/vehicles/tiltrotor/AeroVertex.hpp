...
private:
    void calculateAerodynamicForces(Vector3r &output_force, Vector3r &output_torque)
    {
        ...
        output_force(0) = -ca * f_drag + sa * f_lift;
        output_force(1) = qbar * params_.S * (params_.CY.O + params_.CY.beta * beta + params_.CY.p * p_nondim + params_.CY.r * r_nondim + params_.CY.delta_a * aileron + params_.CY.delta_r * rudder);
        output_force(2) = -sa * f_drag - ca * f_lift;
        output_torque(0) = qbar * params_.S * params_.b * (params_.Cl.O + params_.Cl.beta * beta + params_.Cl.p * p_nondim + params_.Cl.r * r_nondim + params_.Cl.delta_a * aileron + params_.Cl.delta_r * rudder);
        output_torque(1) = qbar * params_.S * params_.c * (params_.Cm.O + params_.Cm.alpha * alpha + params_.Cm.q * q_nondim + params_.Cm.delta_e * elevator);
        output_torque(2) = qbar * params_.S * params_.b * (params_.Cn.O + params_.Cn.beta * beta + params_.Cn.p * p_nondim + params_.Cn.r * r_nondim + params_.Cn.delta_a * aileron + params_.Cn.delta_r * rudder);
    }
