...
namespace airlib_rpclib
{
    ...
    public:
        ...
        struct TiltrotorState
        {
            ...
            {
                return msr::airlib::TiltrotorState(collision.to(), kinematics_estimated.to(), kinematics_true.to(), gps_location.to(), timestamp, landed_state, rc_data.to(), ready, ready_message, can_arm);
            }
        };
    };
