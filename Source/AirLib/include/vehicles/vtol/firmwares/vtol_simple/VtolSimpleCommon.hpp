...
#ifndef msr_airlib_VtolSimpleCommon_hpp
#define msr_airlib_VtolSimpleCommon_hpp
...
namespace airlib
{
    ...
    class VtolSimpleCommon
    {
    public:
        static vtol_simple::Axis3r toAxis3r(const Vector3r& vec)
        {
        ...
        static Vector3r toVector3r(const vtol_simple::Axis3r& vec)
        {
            Vector3r conv;
            conv.x() = vec.x();
            conv.y() = vec.y();
        ...
        static Kinematics::State toKinematicsState3r(const vtol_simple::KinematicsState& state)
        {
        ...
        static vtol_simple::Axis4r toAxis4r(const Quaternionr& q)
        {
            vtol_simple::Axis4r conv;
            conv.x() = q.x();
            conv.y() = q.y();
            conv.z() = q.z();
            conv.val4() = q.w();
        ...
        static Quaternionr toQuaternion(const vtol_simple::Axis4r& q)
        {
            Quaternionr conv;
            conv.x() = q.x();
            conv.y() = q.y();
        ...
        static vtol_simple::GeoPoint toSimpleFlightGeoPoint(const GeoPoint& geo_point)
        {
        ...
        static GeoPoint toGeoPoint(const vtol_simple::GeoPoint& geo_point)
        {
            GeoPoint conv;
            conv.latitude = geo_point.latitude;
            conv.longitude = geo_point.longitude;
