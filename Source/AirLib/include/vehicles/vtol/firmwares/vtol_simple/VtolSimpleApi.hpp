...
#ifndef msr_airlib_VtolSimpleController_hpp
#define msr_airlib_VtolSimpleController_hpp
...
#include "VtolSimpleBoard.hpp"
#include "VtolSimpleCommLink.hpp"
#include "VtolSimpleEstimator.hpp"
...
namespace airlib
{
    ...
    class VtolSimpleApi : public VtolApiBase
    {

    public:
        VtolSimpleApi(const AeroBodyParams* vehicle_params, const AirSimSettings::VehicleSetting* vehicle_setting)
            : vehicle_params_(vehicle_params)
        {
            ...
            board_.reset(new VtolSimpleBoard(&params_));
            comm_link_.reset(new VtolSimpleCommLink());
            estimator_.reset(new VtolSimpleEstimator());

            //create firmware
            firmware_.reset(new vtol_simple::Firmware(&params_, board_.get(), comm_link_.get(), estimator_.get()));
        }

    public: //VehicleApiBase implementation
        virtual void resetImplementation() override
        {
            VtolApiBase::resetImplementation();
        ...
        {
            return VtolSimpleCommon::toGeoPoint(firmware_->offboardApi().getHomeGeoPoint());
        }
    ...
    public: //VtolApiBase implementation
        ...
        {
            VtolApiBase::setSimulatedGroundTruth(kinematics, environment);
    ...
    protected:
        ...
        {
            return VtolSimpleCommon::toKinematicsState3r(firmware_->offboardApi().getStateEstimator().getKinematicsEstimated());
        }

        virtual Vector3r getPosition() const override
        {
            const auto& val = firmware_->offboardApi().getStateEstimator().getPosition();
            return VtolSimpleCommon::toVector3r(val);
        }
        ...
        virtual Quaternionr getOrientation() const override
        {
            ...
            return VtolSimpleCommon::toQuaternion(val);
        }
        ...
        {
            return VtolSimpleCommon::toGeoPoint(firmware_->offboardApi().getGeoPoint());
        }
        ...
        virtual void commandMotorPWMs(const vector<float>& pwm_values) override
        {
            ...
            // typedef vtol_simple::GoalModeType GoalModeType;
            // vtol_simple::GoalMode mode(GoalModeType::Passthrough, GoalModeType::Passthrough, GoalModeType::Passthrough, GoalModeType::Passthrough);

            // vtol_simple::Axis4r goal(front_right_pwm, rear_left_pwm, front_left_pwm, rear_right_pwm);
        ...
        virtual void commandRollPitchYawZ(float roll, float pitch, float yaw, float z) override
        {
            ...
            // typedef vtol_simple::GoalModeType GoalModeType;
            // vtol_simple::GoalMode mode(GoalModeType::AngleLevel, GoalModeType::AngleLevel, GoalModeType::AngleLevel, GoalModeType::PositionWorld);

            // vtol_simple::Axis4r goal(roll, pitch, yaw, z);
        ...
        virtual void commandRollPitchYawThrottle(float roll, float pitch, float yaw, float throttle) override
        {
            ...
            // typedef vtol_simple::GoalModeType GoalModeType;
            // vtol_simple::GoalMode mode(GoalModeType::AngleLevel, GoalModeType::AngleLevel, GoalModeType::AngleLevel, GoalModeType::Passthrough);

            // vtol_simple::Axis4r goal(roll, pitch, yaw, throttle);
        ...
        virtual void commandRollPitchYawrateThrottle(float roll, float pitch, float yaw_rate, float throttle) override
        {
            ...
            // typedef vtol_simple::GoalModeType GoalModeType;
            // vtol_simple::GoalMode mode(GoalModeType::AngleLevel, GoalModeType::AngleLevel, GoalModeType::AngleRate, GoalModeType::Passthrough);

            // vtol_simple::Axis4r goal(roll, pitch, yaw_rate, throttle);
        ...
        virtual void commandRollPitchYawrateZ(float roll, float pitch, float yaw_rate, float z) override
        {
            ...
            // typedef vtol_simple::GoalModeType GoalModeType;
            // vtol_simple::GoalMode mode(GoalModeType::AngleLevel, GoalModeType::AngleLevel, GoalModeType::AngleRate, GoalModeType::PositionWorld);

            // vtol_simple::Axis4r goal(roll, pitch, yaw_rate, z);
        ...
        virtual void commandAngleRatesZ(float roll_rate, float pitch_rate, float yaw_rate, float z) override
        {
            ...
            // typedef vtol_simple::GoalModeType GoalModeType;
            // vtol_simple::GoalMode mode(GoalModeType::AngleRate, GoalModeType::AngleRate, GoalModeType::AngleRate, GoalModeType::PositionWorld);

            // vtol_simple::Axis4r goal(roll_rate, pitch_rate, yaw_rate, z);
        ...
        virtual void commandAngleRatesThrottle(float roll_rate, float pitch_rate, float yaw_rate, float throttle) override
        {
            ...
            // typedef vtol_simple::GoalModeType GoalModeType;
            // vtol_simple::GoalMode mode(GoalModeType::AngleRate, GoalModeType::AngleRate, GoalModeType::AngleRate, GoalModeType::Passthrough);

            // vtol_simple::Axis4r goal(roll_rate, pitch_rate, yaw_rate, throttle);
        ...
        virtual void commandVelocity(float vx, float vy, float vz, const YawMode& yaw_mode) override
        {
            ...
            // typedef vtol_simple::GoalModeType GoalModeType;
            // vtol_simple::GoalMode mode(GoalModeType::VelocityWorld, GoalModeType::VelocityWorld,
            //     yaw_mode.is_rate ? GoalModeType::AngleRate : GoalModeType::AngleLevel,
            //     GoalModeType::VelocityWorld);

            // vtol_simple::Axis4r goal(vy, vx, Utils::degreesToRadians(yaw_mode.yaw_or_rate), vz);
        ...
        virtual void commandVelocityZ(float vx, float vy, float z, const YawMode& yaw_mode) override
        {
            ...
            // vtol_simple::Axis4r goal(vy, vx, Utils::degreesToRadians(yaw_mode.yaw_or_rate), z);
        ...
        {
            // vtol_simple::GoalModeType controller_type_enum = static_cast<vtol_simple::GoalModeType>(controller_type);
            ...
            //     case vtol_simple::GoalModeType::AngleRate:
            ...
            //         break;
            //     case vtol_simple::GoalModeType::AngleLevel:
            //         kp_axis4 = {kp[0], kp[1], kp[2], 1.0};
            //         ki_axis4 = {ki[0], ki[1], ki[2], 0.0};
            //         kd_axis4 = {kd[0], kd[1], kd[2], 0.0};
            ...
            //         params_.gains_changed = true;
            //         break;
            //     case vtol_simple::GoalModeType::VelocityWorld:
            ...
            //         params_.gains_changed = true;
            //         break;
            //     case vtol_simple::GoalModeType::PositionWorld:
            //         kp_axis4 = {kp[1], kp[0], 0.0, kp[2]};
            //         ki_axis4 = {ki[1], ki[0], 0.0, ki[2]};
            //         kd_axis4 = {kd[1], kd[0], 0.0, kd[2]};
        ...
        virtual void commandPosition(float x, float y, float z, const YawMode& yaw_mode) override
        {
            ...
            // typedef vtol_simple::GoalModeType GoalModeType;
            // vtol_simple::GoalMode mode(GoalModeType::PositionWorld, GoalModeType::PositionWorld,
            //     yaw_mode.is_rate ? GoalModeType::AngleRate : GoalModeType::AngleLevel,
            //     GoalModeType::PositionWorld);

            // vtol_simple::Axis4r goal(y, x, Utils::degreesToRadians(yaw_mode.yaw_or_rate), z);
        ...
        virtual const VtolApiParams& getVtolApiParams() const override
        {
            return safety_params_;
        }

        //*** End: VtolApiBase implementation ***//
    ...
    private:
        ...
        {
            params_.default_vehicle_state = vtol_simple::VehicleState::fromString(
    ...
    private:
        ...
        vtol_simple::Params params_;

        unique_ptr<VtolSimpleBoard> board_;
        unique_ptr<VtolSimpleCommLink> comm_link_;
        unique_ptr<VtolSimpleEstimator> estimator_;
        unique_ptr<vtol_simple::IFirmware> firmware_;

        VtolApiParams safety_params_;
