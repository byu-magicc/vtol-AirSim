...
#ifndef msr_airlib_VtolSimpleBoard_hpp
#define msr_airlib_VtolSimpleBoard_hpp
...
namespace airlib
{
    ...
    class VtolSimpleBoard : public vtol_simple::IBoard
    {
    public:
        VtolSimpleBoard(const vtol_simple::Params* params)
            : params_(params)
        {
        }
    ...
    private:
        ...
        const vtol_simple::Params* params_;
