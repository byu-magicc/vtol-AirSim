...
#ifndef msr_airlib_VtolSimpleCommLink_hpp
#define msr_airlib_VtolSimpleCommLink_hpp
...
namespace airlib
{
    ...
    class VtolSimpleCommLink : public vtol_simple::ICommLink
    {
