...
namespace airlib
{
    ...
    class VtolApiBase : public VehicleApiBase
    {
    ...
    protected: //must be implemented
        ...
        virtual const VtolApiParams& getVtolApiParams() const = 0;
    ...
    protected: //types
        ...
        {
        public:
            SingleTaskCall(VtolApiBase* api)
                : SingleCall(api)
            {
                if (isRootCall())
                    api->beforeTask();
        ...
        struct StatusLock
        {
            ...
            StatusLock(const VtolApiBase* api)
                : lock_(
