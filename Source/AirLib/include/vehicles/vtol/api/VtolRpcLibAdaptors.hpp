...
#ifndef air_VtolRpcLibAdaptors_hpp
#define air_VtolRpcLibAdaptors_hpp
...
namespace airlib_rpclib
{
    ...
    class VtolRpcLibAdaptors : public RpcLibAdaptorsBase
    {
    public:
        ...
        struct VtolState
        {
            ...
            VtolState(const msr::airlib::VtolState& s)
            {
            ...
            msr::airlib::VtolState to() const
            {
                return msr::airlib::VtolState(collision.to(), kinematics_estimated.to(), kinematics_true.to(), gps_location.to(), timestamp, landed_state, rc_data.to(), ready, ready_message, can_arm);
            }
        };
    };
