...
class MakerPawnSimApi : public PawnSimApi
{
public:
    ...
    typedef MakerPawnEvents::RotorTiltableInfo RotorTiltableInfo;

public:
    virtual void initialize() override;

    virtual ~MakerPawnSimApi() = default;

    //VehicleSimApiBase interface
    //implements game interface to update pawn
    MakerPawnSimApi(const Params& params);
