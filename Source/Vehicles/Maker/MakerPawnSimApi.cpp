...
MakerPawnSimApi::MakerPawnSimApi(const Params& params)
    : PawnSimApi(params), pawn_events_(static_cast<MakerPawnEvents*>(params.pawn_events))
{
}

void MakerPawnSimApi::initialize()
{
...
void MakerPawnSimApi::pawnTick(float dt)
{
    unused(dt);
    //calls to update* are handled by physics engine and in SimModeWorldBase
}

void MakerPawnSimApi::updateRenderedState(float dt)
{
...
void MakerPawnSimApi::updateRendering(float dt)
{
...
void MakerPawnSimApi::updateRotors()
{
...
void MakerPawnSimApi::setPose(const Pose& pose, bool ignore_collision)
{
...
void MakerPawnSimApi::setPoseCustom(const Pose& pose, const vector<float>& tilt_angles, bool ignore_collision, bool spin_props)
{
...
void MakerPawnSimApi::resetImplementation()
{
...
void MakerPawnSimApi::reportState(StateReporter& reporter)
{
...
MakerPawnSimApi::UpdatableObject* MakerPawnSimApi::getPhysicsBody()
{
